...
class FilesPage(ctk.CTkFrame):
    ...
    def _build(self) -> None:
        ...
        explorer = ctk.CTkFrame(self, fg_color="#111827", corner_radius=14)
        ...
        ctk.CTkTextbox(explorer, width=220, fg_color="#0f172a", corner_radius=10).grid(
            row=0, column=0, padx=14, pady=14, sticky="ns"
        )
        ctk.CTkTextbox(explorer, fg_color="#0f172a", corner_radius=10).grid(
